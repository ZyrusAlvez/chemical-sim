...
const calciumOxide = new Compound("Calcium Oxide", "CaO", "solid", "oxide", "", "", 0.1, new Map([[calcium, 1], [oxygen, 1]]), "assets/compound/calciumoxide.png", "cao", "assets/speech/hint/cao2.png");
...
const ironSulfate = new Compound("Iron (II) Sulfate", "FeSO4", "liquid", "salt solution", "", "", 0.08, new Map([[iron, 1], [sulfur, 1], [oxygen, 4]]), "assets/compound/copperSulfate.png", "feso4", "assets/speech/hint/copperSulfate.png");
